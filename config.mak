...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cc='gcc -lstdc++' --cxx=g++ --extra-cxxflags='-g -std=c++11 -Wall -Wextra' --extra-libs='-lboost_filesystem -lmyfunc -lwrapperndn' --enable-pthreads --enable-ffplay
prefix=/usr/local
...
CFLAGS=   -std=c11 -fomit-frame-pointer -pthread -D_REENTRANT -I/usr/include/SDL2  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS= -g -std=c++11 -Wall -Wextra -D__STDC_CONSTANT_MACROS -std=c++98
OBJCFLAGS=  
ASFLAGS=   -g
AS_C=-c
AS_O=-o $@
...
EXTRALIBS=-lXv -lX11 -lXext -ldl -ldl -lvdpau -lva -lva-drm -lva -lva-x11 -lva -lxcb -lxcb-shm -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lxcb-shape -lxcb -lX11 -lsndio -lasound -lSDL2 -lm -llzma -lbz2 -lz -pthread -lboost_filesystem -lmyfunc -lwrapperndn 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
libavcodec_VERSION=57.82.102
libavcodec_VERSION_MAJOR=57
libavcodec_VERSION_MINOR=82
