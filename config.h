...
#define FFMPEG_CONFIGURATION "--cc='gcc -lstdc++' --cxx=g++ --extra-cxxflags='-g -std=c++11 -Wall -Wextra' --extra-libs='-lboost_filesystem -lmyfunc -lwrapperndn' --enable-pthreads --enable-ffplay"
